...
// Implement Student class member functions
...
// Implement Course class member functions
Course::Course(std::string name, double fee)
...
// Implement AdmissionProcess class member functions
...
void AdmissionProcess::EnrollStudentInCourse(Student& student, const Course& course) {
